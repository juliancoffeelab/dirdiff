...
Items in [followups.md](followups.md) are explicit post-rewrite work, not deferred implementation inside a practical chapter. Do not pull a TODO or FIXME from that file into Chapters 1–10 without a separate user decision.
