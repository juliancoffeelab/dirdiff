...
Chapter 6 adds only direct non-hunk hotkeys and HelpModal. Chapter 7 integrates explicit DOM hunk navigation, Chapter 8 adds scroll-only FileTree navigation, and Chapter 9 later adds approved recognized user-scroll following. None may move virtualization policy or render mode into Navigation.
