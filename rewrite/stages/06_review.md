...
After Chapter 5, `v_new` remains available for continued review, correction and direct user feedback.
...
- treating `v_new` as accepted merely because Chapters 1–5 were implemented.
