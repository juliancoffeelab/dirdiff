...
This folder is only for substantial Playwright documentation.

Use it for browser scenarios where the surrounding explanation matters:

- the behavior is hard to infer from the test name alone
