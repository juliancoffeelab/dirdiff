...
- [Pytest CLI behavior](./pytest/cli.md)
...
The pytest layer covers Python-side diff and CLI behavior and also makes the JS hunk-nav tests part of the normal `uv run pytest` workflow.
