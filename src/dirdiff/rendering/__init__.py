...
as syntax spans, fold hints, plain-render elision, truncation markers, and
...
HTTP route responses.  Syntax highlighting and large-plain-render behavior live
in `base.py`; structural fold discovery lives in `fold.py`.
"""
